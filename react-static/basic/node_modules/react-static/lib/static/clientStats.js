...
function outputClientStats(config, statsJSON) {
  return _fsExtra.default.outputFileSync(_path.default.join(config.paths.DIST, 'client-stats.json'), JSON.stringify(statsJSON, null, 2));
}
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _fsExtra.default.readJson(_path.default.join(config.paths.DIST, 'client-stats.json'));
